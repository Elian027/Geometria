                        ...
                        while(!pausaA){
                            ...
                            switch (opA) {
                                ...
                                /*case 7: {
                                    ...
                                    nLados = sc.nextInt();
                                    calculo.setDato1(nLados);
                                    System.out.print("Ingrese el apotema: ");
                                    apotema = sc.nextDouble();
                                    calculo.setDatoDouble1(apotema);
                                    System.out.print("Ingrese la longitud de un lado: ");
                                    ladoPol = sc.nextDouble();
                                    calculo.setDatoDouble2(ladoPol);
                                    double perimetroPo = ladoPol * nLados;
                                    System.out.println("El area del Poligono Regular es: " + ((perimetroPo * apotema) / 2));
                                }
                                break;*/
                                case 8: {
                        ...
                        while(!pausaP){
                            ...
                            switch (opP) {
                                ...
                                /*case 7: {
                                    ...
                                    int nLadosPPR;
                                    double ladoPPR;
                                    System.out.print("Ingrese el lado del Poligono Regular: ");
                                    ladoPPR = sc.nextDouble();
                                    calculo.setDatoDouble1(ladoPPR);
                                    System.out.print("Ingrese el numero de lados: ");
                                    nLadosPPR = sc.nextInt();
                                    calculo.setDato1(nLadosPPR);
                                    System.out.println("El perimetro del Poligono Regular es: " + (dc.format(calculo.getDato1() * calculo.getDatoDouble1())));
                                }
                                break;*/
                                case 8: {
                                    System.out.println(VERDE + "\n\t\tVolviendo al menu principal...." + RESET);
                        ...
                        while(!pausaV){
                            ...
                            switch (opV) {
                                case 1: {
                                    ...
                                    System.out.println("El volumen de la piramide es: " + (dc.format((Math.pow(aristaPi, 3)) * (Math.pow(2,0.5))/12)));
                                }
                                break;
                                /*case 2: {
                                    ...
                                    calculo.setDatoDouble1(aristaPCu);
                                    System.out.println("El volumen del cubo es: " + (dc.format(Math.pow(aristaPCu,3))));
                                }
                                break;
                                case 3: {
                                    ...
                                    calculo.setDatoDouble1(aristaPOc);
                                    System.out.println("El volumen del Octaedro es: " + (dc.format((Math.pow(aristaPOc,3))*(Math.pow(2,0.5)/3))));
                                }
                                break;
                                case 4: {
                                    ...
                                    calculo.setDatoDouble1(radioVCi);
                                    System.out.print("Ingrese la altura del cilindro: ");
                                    alturaVCi = sc.nextDouble();
                                    calculo.setDatoDouble2(alturaVCi);
                                    System.out.println("El volumen del Cilindro es: " + (dc.format(pi * Math.pow(radioVCi,2) * alturaVCi)));
                                }
                                break;
                                case 5: {
